      ...
      <Container fluid>
        <Row className='banner-1'>
          <Col className='banner-1 title' xs={{offset: 2, span: 5}}>
            ...
            <Button className='banner-1'><h3 className='banner-1'>SHOP NOW</h3></Button>
          </Col>
          <Col xs={{span: 2}}>
          <img src="/banner-1.png" alt="" className='banner-1 image' width="415px"/>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col className='categories hats'>
            ...
            <a href='#athleisure'>
              <img src="/athleisure.png" alt="" height="232px" className='athleisure'/>
            </a>
          </Col>
        </Row>
