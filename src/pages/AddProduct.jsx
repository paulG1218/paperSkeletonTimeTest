    ...
    <Form className='add-product-form' onSubmit={(e) => handleSubmit(e)}>
        ...
        <Row className='add-sizes-row'>
            ...
            <Form.Check
                ...
                onChange={() => setSizesState({...sizesState, XS: !sizesState.XS})}
            ...
            <Form.Check
                ...
                className='size-checkbox'
                disabled={sizesState.OS}
                onChange={() => setSizesState({...sizesState, XL: !sizesState.XL})}
            ...
            <Form.Check
                ...
                label="One Size"
                className='size-checkbox'
                onChange={() => setSizesState({...sizesState, OS: !sizesState.OS})}
        ...
        <Row className='add-colors-row'>
            ...
            {colorInputs}
            <button className='add-color' type="button" onClick={() => setColorCount((prevState) => [...prevState, prevState[prevState.length - 1] + 1])}>+</button>
            <button className='remove-color' type="button" onClick={() => setColorCount((prevState) => prevState.slice(0, -1))}>-</button>
        </Row>
        <Button size='lg' className='create-item-btn' type='submit'>Create</Button>
     </Form>
    </Container>
  )
}
